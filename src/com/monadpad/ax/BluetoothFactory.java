...
public class BluetoothFactory {
    ...
    private static final String NAME = "SUPER DRAW MUSIC";
    ...
    public BluetoothFactory(Context context, BluetoothStatusCallback statusCallback) {
    ...
    public static boolean initialize(Activity activity) {
        // Android bug, if getDefaultAdapter
        // this isn't done in the activity
        // it RuntimeError's in the service
        // this line initializes Bluetooth
        // meaning it succeeds in the service
        ...
        if (!bta.isEnabled()){
            ...
            //todo activity.registerReceiver(btS)
            return false;
        }
        return true;
    }
